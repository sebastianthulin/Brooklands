...
class LatestCars extends \Modularity\Module
{
    public $args = array(
        'id' => 'latestcars',
        'nameSingular' => 'Latests Cars',
        'namePlural' => 'Latests Cars',
        'description' => 'Module to show the latest cars from cars post type.',
