...
class AdjustedImage extends \Modularity\Module
{
    public $args = array(
        'id' => 'flexible',
        'nameSingular' => 'Adjusted Image',
        'namePlural' => 'Adjusted Images',
        'description' => 'Flexible content with images on the right or left of text.',
        'supports' => array(),
