...
class OverlayImage extends \Modularity\Module
{
    public $args = array(
        'id' => 'flexibleoverlay',
        'nameSingular' => 'Overlay Image',
        'namePlural' => 'Overlay Images',
        'description' => 'Flexible content with images behind the content.',
        'supports' => array(),
